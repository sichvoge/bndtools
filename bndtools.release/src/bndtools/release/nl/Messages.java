...
public class Messages extends NLS {
    ...
    public static String errorDialogTitle; /* bndtools.release.ErrorDialog::configureShell */
    ...
    public static String project1; /* bndtools.release.ReleaseJob::run */
    ...
    public static String releaseDialogTitle; /* bndtools.release.BundleReleaseDialog::configureShell */
    ...
    public static String version; /* bndtools.release.ui.BundleTree::createInfoViewer */
